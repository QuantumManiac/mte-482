...
def zmq_to_serial(context: zmq.Context, uart_port: str):
    ...
    while True:
        ...
        if push_msg != '0':
            ...
            print("here")
            left = float(adc_msg["channel0"]) - float(adc_msg["channel1"])
            right = float(adc_msg["channel2"]) - float(adc_msg["channel3"])
